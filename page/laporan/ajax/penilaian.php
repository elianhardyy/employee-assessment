...
<table id="example2" class="table table-bordered table-striped table-jq">
            ...
            <tbody>
                ...
                <?php if(number_format($row['penilaian_koordinator'],1) == 0.0 <= 20.0 ){?>
                    <td>Tidak Memuaskan</td>
                <?php }else if(number_format($row['penilaian_koordinator'],1) == 20.1 <= 40.0 ){?>
                    <td>Kurang Memuaskan</td>
                <?php }else if(number_format($row['penilaian_koordinator'],1) == 40.1 <= 60.0 ){?>
                    <td>Cukup Memuaskan</td>
                <?php }else if(number_format($row['penilaian_koordinator'],1) == 60.1 <= 80.0 ){?>
                    <td>Memuaskan</td>
                <?php }else{?>
