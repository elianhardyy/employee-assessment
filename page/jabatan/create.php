        ...
        <form role="form" method="post">
          <div class="box-body">
            <div class="form-group">
              ...
              <input type="text" id="NJ" name="NJ" class="form-control input-lg" placeholder="Nama Jabatan">
            </div>
            <div class="form-group">
              <label for="exampleInputEmail1">Job Description</label>
              <textarea name="JD" id="JD" placeholder="Masukan Job Description" class="form-control input-lg" id="exampleInputEmail1"></textarea>
...
<script>
  $("#po").click(function(){
    ...
    $.ajax({
      method:"POST",
      url:"functions/index.php?r=insertJabatan",
      data:{
        JD:jd,
        NJ:nj,
      },
