...
if($_SESSION['logged'] == 1){
    $subkr = mysqli_query($con,"SELECT * FROM $tb_sub_kriteria RIGHT JOIN $tb_kriteria ON $tb_sub_kriteria.$id_kfk = $tb_kriteria.$idkrit LEFT JOIN penilaian_pemilik ON $tb_sub_kriteria.$idsbk = penilaian_pemilik.id_sub_kriteria_fk WHERE $tb_sub_kriteria.$id_kfk='$sk' AND penilaian_pemilik.id_karyawan_fk = $idkar");
...
if($_SESSION['logged'] == 3){
    $subkr = mysqli_query($con,"SELECT * FROM $tb_sub_kriteria RIGHT JOIN $tb_kriteria ON $tb_sub_kriteria.$id_kfk = $tb_kriteria.$idkrit LEFT JOIN penilaian_koor_gudang ON $tb_sub_kriteria.$idsbk = penilaian_koor_gudang.id_sub_kriteria_fk WHERE $tb_sub_kriteria.$id_kfk='$sk' AND penilaian_koor_gudang.id_karyawan_fk = $idkar");
    $nilai = 'nilai_akhir_gudang';
}
if($_SESSION['logged'] == 4){
    $subkr = mysqli_query($con,"SELECT * FROM $tb_sub_kriteria RIGHT JOIN $tb_kriteria ON $tb_sub_kriteria.$id_kfk = $tb_kriteria.$idkrit LEFT JOIN penilaian_koor_penjualan ON $tb_sub_kriteria.$idsbk = penilaian_koor_penjualan.id_sub_kriteria_fk WHERE $tb_sub_kriteria.$id_kfk='$sk' AND penilaian_koor_penjualan.id_karyawan_fk = $idkar");
                    ...
                    <table class="table table-bordered table-striped" id="tb-kr">
                        ...
                        <?php if($subkrlen == 0): ?>
                            ...
                            <tr>
                                <td>
                                    <label>
                                        ...
                                        <p class="idr1" hidden><?= $v[$idsbk]?></p><p class="idkr1" hidden><?= $v[$idkrit]?></p>
                            ...
                            <tr>
                                <td>
                                    <label for="">
                                        ...
                                        <p class="idr2" hidden><?= $v[$idsbk]?></p><p class="idkr2" hidden><?= $v[$idkrit]?></p>
                            ...
                            <tr>
                                <td>
                                    <label for="">
                                        ...
                                        <p class="idr3" hidden><?= $v[$idsbk]?></p><p class="idkr3" hidden><?= $v[$idkrit]?></p>
                            ...
                            <tr>
                                <td>
                                    <label for="">
                                        ...
                                        <p class="idr4" hidden><?= $v[$idsbk]?></p><p class="idkr4" hidden><?= $v[$idkrit]?></p>
                            ...
                            <tr>
                                <td>
                                    <label for="">
                                        ...
                                        <p class="idr5" hidden><?= $v[$idsbk]?></p><p class="idkr5" hidden><?= $v[$idkrit]?></p>
                            ...
                            <tr>
                                <td>
                                    <label>
                                        <input type="radio" class="radUpdate1" value="1" <?php if($v[$nilai]==1 && $v['id_karyawan_fk'] == $idk && $v[$idsbk] == $v['id_sub_kriteria_fk']){ echo "checked";}else{echo " ";}?> >
                                        <p class="idr1" hidden><?= $v[$idsbk]?></p><p class="idkr1" hidden><?= $v[$idkrit]?></p>
                                        <span>1</span><span><?= $v[$m1jenis] ?></span>
                                    </label>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <label for="">
                                        <input type="radio" class="radUpdate2" value="2" <?php if($v[$nilai]==2 && $v['id_karyawan_fk'] == $idk && $v[$idsbk] == $v['id_sub_kriteria_fk']){ echo "checked";}else{echo " ";}?> >
                                        <p class="idr2" hidden><?= $v[$idsbk]?></p><p class="idkr2" hidden><?= $v[$idkrit]?></p>
                                        <span>2</span><span><?= $v[$m2jenis]?></span>
                                    </label>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <label for="">
                                        <input type="radio" class="radUpdate3" value="3" <?php if($v[$nilai]==3 && $v['id_karyawan_fk'] == $idk && $v[$idsbk] == $v['id_sub_kriteria_fk']){ echo "checked";}else{echo " ";}?> >
                                        <p class="idr3" hidden><?= $v[$idsbk]?></p><p class="idkr3" hidden><?= $v[$idkrit]?></p>
                                        <span>3</span><span><?= $v[$m3jenis]?></span>
                                    </label>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <label for="">
                                        <input type="radio" class="radUpdate4" value="4" <?php if($v[$nilai]==4 && $v['id_karyawan_fk'] == $idk && $v[$idsbk] == $v['id_sub_kriteria_fk']){ echo "checked";}else{echo " ";}?> >
                                        <p class="idr4" hidden><?= $v[$idsbk]?></p><p class="idkr4" hidden><?= $v[$idkrit]?></p>
                                        <span>4</span><span><?= $v[$m4jenis]?></span>
                                    </label>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <label for="">
                                        <input type="radio" class="radUpdate5" value="5" <?php if($v[$nilai]==5 && $v['id_karyawan_fk'] == $idk && $v[$idsbk] == $v['id_sub_kriteria_fk']){ echo "checked";}else{echo " ";}?> >
                                        <p class="idr5" hidden><?= $v[$idsbk]?></p><p class="idkr5" hidden><?= $v[$idkrit]?></p>
                                        <span>5</span><span><?= $v[$m5jenis]?></span>
                                    </label>
                                </td>
