    ...
    <div class="col-xs-12">
      ...
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Penilaian Staff Penjualan</h3><h3 class="box-title pull-right"><a href="?p=jabatan&act=create" class="btn btn-success"><i class="fa fa-user"></i> Tambah Data jabatan</a></h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
            	<?php 
            		...
            		$sql = "SELECT * from karyawan where jabatan='Staf Penjualan'";
            		$query = mysqli_query($con, $sql);
