...
UD. START PURNAMA
            ...
            <p class="no-margin">
            <strong>Badan Hukum No. : 228/BH/KWK.22/III/1996</strong><br>
            Jl. Bulak Banteng No. 123 - Kota Surabaya<br>
            Telp./Fax. 0361 9311605
            </p>
            </div>
            </div>
...
$html .= '
        <tr>
          ...
          <td><strong>' . $karyawan['nilai_akhir_pemilik'] . '</strong></td>
          <td><strong>' . $karyawan['nilai_akhir'] . '</strong></td>
        </tr>
        <tr>
        <td colspan="2" class="text-center align-center"><strong>Nilai Akhir</strong></td>';
$html .= '<td colspan="2" class="text-center align-center"><strong>' . $nilaiTotal . '</strong></td>';
$html .= '</tr>
      </tbody>
  </table>
