...
$html .= '<td><strong>' . $karyawan['nilai_akhir'] . '</strong></td>
        </tr>
        <tr>
          <td colspan="2" class="text-center align-center"><strong>Nilai Akhir</strong></td>';
$html .= '<td colspan="2" class="text-center align-center"><strong>' . ($karyawan['nilai_akhir_pemilik'] * 0.4) + ($karyawan['nilai_akhir'] * 0.6) . '</strong></td>';
$html .= '</tr>
      </tbody>
  </table>
